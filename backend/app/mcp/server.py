...
def handle_request(request: dict) -> dict:
    ...
    if method == "tools/list":
        return {"tools": [
            ...
            {"name": "search-menu", "description": "Find menu items by name or category with price and availability.", "inputSchema": {"type": "object", "properties": {"query": {"type": "string"}}, "required": ["query"]}},

...
| AI and knowledge search | Amazon Bedrock (OpenAI GPT-OSS 20B), Amazon Titan Text Embeddings V2, Qdrant |
| Voice | Amazon Chime SDK, Amazon Transcribe, Amazon Polly |
| Documents and storage | Amazon S3, Amazon Textract |
...
The responsive customer interface provides the menu, AI voice assistance and order confirmation.

<table>
  <tr>
    <td width="25%"><img src="docs/images/product/mobile-menu.png" alt="CallDine mobile menu" /></td>
    <td width="25%"><img src="docs/images/product/mobile-voice-processing.png" alt="Voice assistant processing a request" /></td>
    <td width="25%"><img src="docs/images/product/mobile-voice-confirmed.png" alt="Voice assistant confirming a reservation" /></td>
    <td width="25%"><img src="docs/images/product/mobile-order-confirmed.png" alt="Confirmed customer order" /></td>
  </tr>
</table>

### Restaurant operations

The admin area brings together daily activity, customer–AI call transcripts, table availability, demand recommendations and assistant configuration.

![CallDine admin dashboard](docs/images/product/admin-dashboard.png)

![Admin order management](docs/images/product/admin-orders.png)

![Admin menu management](docs/images/product/admin-menu.png)

![Order conversation between a customer and the CallDine AI](docs/images/product/order-conversation.png)

![Reservation calendar with a confirmed table booking](docs/images/product/reservation-calendar.png)

![Demand recommendations](docs/images/product/demand-recommendations.png)

![Assistant settings](docs/images/product/assistant-settings.png)
